...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <h3>Updating Complete Status of an Item</h3>
      ...
      onChange={(e) => {
        ...
        setTodo({ ...todo, completed: updatedStatus});
      }}
      className="form-select w-50 float-start me-2">
      ...
      <a href={`${API}/${todo.id}/completed/${todo.description}`} className="btn btn-primary float-end">
        Update Status</a>     
      <input value={todo.id} className="form-control w-25 float-start me-2"
        onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
